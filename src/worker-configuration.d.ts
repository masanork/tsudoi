/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: b1bb52c5b2e072cb5f85c1ff53be911e)
// Runtime types generated with workerd@1.20260921.1 2026-09-21 nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMITS: KVNamespace;
	ENCRYPTED_ATTACHMENTS: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	NOTIFICATION_QUEUE: Queue;
	ASSETS: Fetcher;
	APP_ORIGIN: "https://staging.tsudoi.example.com" | "https://tsudoi.example.com" | "http://localhost:8787";
	RP_ID: "staging.tsudoi.example.com" | "tsudoi.example.com" | "localhost";
	RP_NAME: "tsudoi (staging)" | "tsudoi";
	OIDC_ISSUER: "https://mikaki.tossa.app" | "";
	OIDC_CLIENT_ID: "";
	OIDC_KEY_ID: "";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		NOTIFICATION_QUEUE: Queue;
		ASSETS: Fetcher;
		APP_ORIGIN: "https://staging.tsudoi.example.com";
		RP_ID: "staging.tsudoi.example.com";
		RP_NAME: "tsudoi (staging)";
		OIDC_ISSUER: "https://mikaki.tossa.app";
		OIDC_CLIENT_ID: "";
		OIDC_KEY_ID: "";
		EMAIL_FROM: "noreply@example.com";
	...
	interface ProductionEnv {
		...
		NOTIFICATION_QUEUE: Queue;
		ASSETS: Fetcher;
		APP_ORIGIN: "https://tsudoi.example.com";
		RP_ID: "tsudoi.example.com";
		RP_NAME: "tsudoi";
		OIDC_ISSUER: "https://mikaki.tossa.app";
		OIDC_CLIENT_ID: "";
		OIDC_KEY_ID: "";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "RP_ID" | "RP_NAME" | "OIDC_ISSUER" | "OIDC_CLIENT_ID" | "OIDC_KEY_ID" | "EMAIL_FROM">> {}
}
